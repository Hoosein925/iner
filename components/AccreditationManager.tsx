        ...
        <div className="p-4 sm:p-6 lg:p-8">
            <div className="flex flex-wrap justify-between items-center mb-6 gap-4">
                <div className="flex items-center gap-3">
                    ...
                    >
                        <BackIcon className="w-5 h-5 text-green-600 dark:text-green-400" />
                        <span>بازگشت به لیست بخش‌ها</span>
                    </button>
                    <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-slate-100">مدیریت مطالب اعتباربخشی</h1>
                </div>
            </div>

            <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6">
                <h2 className="text-xl font-bold mb-4">بارگذاری محتوای جدید</h2>
                ...
                <div className="mt-8">
                    <h3 className="text-xl font-bold mb-4 border-t pt-6 border-slate-200 dark:border-slate-700">محتوای بارگذاری شده</h3>
                    {materials.length === 0 ? (
